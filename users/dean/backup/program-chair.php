                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php">Registrar Program Chair</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="documentUploadModalLabel">Assigned Program Chair</h5>
                            ...
                            <form id="documentUploadForm" action="submit_document.php" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="session_campus" name="session_campus"
                                        value="<?= htmlspecialchars($campus); ?>" readonly>
                                ...
                                <!-- Program Chair Name -->
                                <div class="form-group">
                                    <label for="programChair">Program Chair Name</label>
                                    <input type="text" class="form-control" id="programChair" name="program_chair_name"
                                        placeholder="Enter Program Chair name" required>
                                </div>

                                <div class="form-group">
                                    <label for="usermail">Program Chair Email</label>
                                    <input type="text" class="form-control" id="usermail" name="usermail"
                                        placeholder="Enter Program Chair email" required>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT id, course_program,	program_chair, status, assigned_at FROM assigned_program_chairs";
