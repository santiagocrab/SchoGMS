<?php
/**
 * Lean CSS/JS bundle for coordinator pages (avoids dashboard chart libs on every tab).
 */
if (!function_exists('schogms_coordinator_head')) {
    function schogms_coordinator_head(bool $datatables = false): void
    {
...
if (!function_exists('schogms_coordinator_footer_scripts')) {
    /**
     * @param array{datatables?:bool,sweetalert?:bool,chart?:bool} $opts
     */
    function schogms_coordinator_footer_scripts(array $opts = []): void
    {
        ...
        if ($datatables) {
            ...
            echo '<script>$(function(){if(!$.fn.DataTable)return;var o={pageLength:25,lengthMenu:[[10,25,50,100,-1],[10,25,50,100,"All"]],deferRender:true,processing:true,stateSave:false,order:[]};$("#zero_config, #reqTable").each(function(){if(!$.fn.dataTable.isDataTable(this))$(this).DataTable(o);});});</script>' . "\n";
        }
