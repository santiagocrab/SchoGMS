                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="row">
                                            <!--<div class="col-md-3">-->
                                            <!--    <form method="GET" action="validated_masterlist_tes.php" id="filterForm"-->
                                            <!--        onsubmit="return openNewWindow(event)">-->
                                            <!--        <input type="hidden" name="sheet_name"-->
                                            <!--            value="<?php echo htmlspecialchars($sheet_name); ?>">-->
                                            <!--        <button type="submit" class="btn btn-success btn-rounded">Export TES Form</button>-->
                                            <!--    </form>-->
                                            <!--</div>-->
                                            <!--<div class="col" >-->
                                            <!--    <form method="GET" action="validated_masterlist_tes_delisting.php" id="filterForm2"-->
                                            <!--        onsubmit="return openNewWindow2(event)">-->
                                            <!--        <input type="hidden" name="sheet_name"-->
                                            <!--            value="<?php echo htmlspecialchars($sheet_name); ?>">-->
                                            <!--        <button type="submit" class="btn btn-success btn-rounded">Export TES Delisting Form</button>-->
                                            <!--    </form>-->
                                            <!--</div>-->
                                            <div class="col" >
                                                <form method="GET" action="validated_remarks_tes.php" id="filterForm3"
                                        ...
                                        <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()): 
                                                    ...
                                                    // Find COR document - using same logic as validate.php that works
                                                    $corQuery1 = [
                                                    ...
                                                    // Find COG document - using same logic as validate.php
                                                    $cogQuery1 = [
                                                        'original_name' => ['$regex' => '^' . $pattern1 . '(\.pdf)?$', '$options' => 'i'],
                                                        'category' => 'COG'
                                                    ];
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                $hasCogDoc = ($cogDoc !== null && isset($cogDoc['file_path']));
