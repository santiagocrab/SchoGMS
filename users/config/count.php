...
<?php
// Include the database connection file
require_once 'db_connection.php'; // Modify with the actual connection path

// SQL query to count distinct course_program_enrolled
$sql = "SELECT COUNT(DISTINCT course_program_enrolled) AS total_courses FROM ched_masterlist";
...
$sql = "SELECT COUNT(DISTINCT file_group) AS total_file_groups FROM ched_masterlist";
