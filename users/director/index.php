...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $totalRecordsQuery = "SELECT COUNT(*) AS total_records FROM ched_masterlist where sheet_name = '$sheet_name'";
                $totalRecordsQueryTes = "SELECT COUNT(*) AS total_records FROM ched_masterlist_tes where campus = '$sheet_name'";
                $totalCoursesQuery = "SELECT COUNT(DISTINCT course_program_enrolled) AS total_courses FROM ched_masterlist where sheet_name = '$sheet_name'";
                $totalFileGroupsQuery = "SELECT COUNT(DISTINCT file_group) AS total_file_groups FROM ched_masterlist where sheet_name = '$sheet_name'";
                $totalFilenamesQuery = "SELECT COUNT(DISTINCT filename) AS total_filenames FROM ched_masterlist where sheet_name = '$sheet_name'";
                ...
                $totalRecordsTes = $totalRecordsResultTes ? $totalRecordsResultTes->fetch_assoc()['total_records'] : 0;
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Courses TDP</h4>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Courses TES</h4>
    ...
    $.ajax({
        url: 'fetch_chart.php', // Ensure this path is correct
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            ...
            // Update the total records count in the page
            $('#total-records-count').text(totalRecords);

            // Prepare data for the chart
            var courseLabels = totalCourses.map(course => course.course);
            var courseCounts = totalCourses.map(course => course.count);

            // Chart options with hidden X-axis labels
            var chartOptions = {
                scales: {
                    x: {
    ...
    <script>
        $(document).ready(function () {
    $.ajax({
        url: 'fetch_chart_tes.php', // Ensure this path is correct
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            // Extract response data
