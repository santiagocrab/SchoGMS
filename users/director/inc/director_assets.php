<?php
/**
 * Lean CSS/JS for director pages (sidebar + datatables).
 */
if (!function_exists('schogms_director_head')) {
    function schogms_director_head(bool $datatables = false): void
    {
...
if (!function_exists('schogms_director_footer_scripts')) {
    /** @param array{datatables?:bool} $opts */
    function schogms_director_footer_scripts(array $opts = []): void
    {
        ...
        if ($datatables) {
            ...
            echo '<script>$(function(){if(!$.fn.DataTable)return;var o={pageLength:25,lengthMenu:[[10,25,50,100,-1],[10,25,50,100,"All"]],deferRender:true,processing:true,stateSave:false,order:[]};$("#director_scholar_table").each(function(){if(!$.fn.dataTable.isDataTable(this))$(this).DataTable(o);});});</script>' . "\n";
        }
