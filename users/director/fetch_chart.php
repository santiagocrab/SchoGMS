...
$totalRecordsQuery = "SELECT COUNT(*) AS total_records FROM ched_masterlist WHERE sheet_name = ?";
...
$totalCourses = [];
$coursesQuery = "SELECT course_program_enrolled AS course, COUNT(*) AS count FROM ched_masterlist WHERE sheet_name = ? GROUP BY course_program_enrolled";
