...
<head>
    ...
    <title>TDP scholars | SchoGMS</title>
    <?php schogms_director_head(true); ?>
</head>
<body>
<?php schogms_director_shell_open('TDP scholars'); ?>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active">TDP scholars</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <?php schogms_director_render_scholar_list($conn, $campus, 'tdp'); ?>
            </div>
