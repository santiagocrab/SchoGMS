                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="table-responsive">
                                        ...
                                        $sheetNameQuery = "SELECT DISTINCT sheet_name FROM ched_masterlist_tes";
                                            ...
                                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                                ...
                                                <tbody>
                                                    <?php while ($row = $result->fetch_assoc()): ?>
                                                            ...
                                                            <td><?php echo htmlspecialchars($row['el']); ?></td>
                                                            <td><?php echo htmlspecialchars($row['cor']); ?></td>
                                                            <td><?php echo htmlspecialchars($row['form2']); ?></td>
                                                            <td><?php echo htmlspecialchars($row['portal']); ?></td>
                                                            <td><?php echo htmlspecialchars($row['unifastremarks']); ?></td>
                                                            <td><?php echo htmlspecialchars($row['heiremarks']); ?></td>
                                                        </tr>
                                                    <?php endwhile; ?>
                                                </tbody>
                                            </table>
