...
$recentUploads = [];
$res = $conn->query(
    "SELECT file_group, campus, filename,
            MAX(upload_time) AS upload_date,
            COUNT(*) AS record_count
     FROM ched_masterlist_tes
     GROUP BY file_group, campus, filename
...
<head>
    ...
    <title>Upload TES masterlist — SchoGMS</title>
...
<?php require_once __DIR__ . '/inc/chairman_nav.php'; schogms_chairman_shell_open('Upload TES'); ?>
        <div class="container-fluid">
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Upload TES masterlist</li>
                    </ol>
                </nav>
            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="campus" name="campus" required>
                                                ...
                                                <?php endforeach;
                                                $campusRes = $conn->query('SELECT DISTINCT campus FROM ched_masterlist_tes ORDER BY campus');
                                                if ($campusRes) {
                                                    while ($cr = $campusRes->fetch_assoc()) {
                                                        $sn = trim((string) ($cr['campus'] ?? ''));
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="file_group" name="file_group"
                                                placeholder="e.g. CHED TES 2024-2025 1st Sem" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <?php else: ?>
                                    <?php foreach ($recentUploads as $u): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars((string) $u['campus'], ENT_QUOTES, 'UTF-8') ?></td>
                    ...
                    <a href="ched_masterlist_tes.php" class="btn btn-outline-primary btn-sm">View TES masterlist</a>
                </div>
            </div>
        </div>
<?php
