...
$docData = schogms_registrar_documents($conn, $campusFilter, 'COR');
...
<?php schogms_registrar_shell_open('COR documents'); ?>
            ...
            <div class="container-fluid">
                ...
                schogms_coordinator_render_cor_cog_format('COR', $campusFilter, '../coordinator/');
                ?>
            </div>
<?php
