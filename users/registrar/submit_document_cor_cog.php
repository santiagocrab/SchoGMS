<?php
/**
 * Registrar COR / COG upload — same pipeline as coordinator (masterlist match + document_uploads).
 */
...
if ($masterlistIndex === []) {
    echo json_encode([
        'success' => false,
        'message' => 'No scholars on the CHED masterlist for this campus. Upload CHED TDP/TES masterlist first (coordinator).',
    ]);
    exit;
}
