<?php
/**
 * Unified registrar top bar + sidebar.
 */

if (!function_exists('schogms_registrar_nav_script')) {
    function schogms_registrar_nav_script(): string
    {
        return basename($_SERVER['SCRIPT_NAME'] ?? '');
    }
}

if (!function_exists('schogms_registrar_nav_active')) {
    function schogms_registrar_nav_active(string $script, array $aliases = []): bool
    {
        $current = schogms_registrar_nav_script();

        return $current === $script || in_array($current, $aliases, true);
    }
}

if (!function_exists('schogms_registrar_nav_link_class')) {
    function schogms_registrar_nav_link_class(string $script, array $aliases = []): string
    {
        $class = 'sidebar-link sidebar-link';

        return schogms_registrar_nav_active($script, $aliases)
            ? $class . ' active'
            : $class;
    }
}
...
if (!function_exists('schogms_registrar_sidebar_menu_items')) {
    function schogms_registrar_sidebar_menu_items(): void
    {
        ?>
                        <li class="sidebar-item">
                            <a class="<?= schogms_registrar_nav_link_class('index.php') ?>" href="index.php">
                        ...
                        <li class="sidebar-item">
                            <a class="<?= schogms_registrar_nav_link_class('masterlist.php') ?>" href="masterlist.php">
                        ...
                        <li class="sidebar-item">
                            <a class="<?= schogms_registrar_nav_link_class('requirements.php') ?>" href="requirements.php">
                        ...
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">CHED &amp; billing</span></li>
                        <li class="sidebar-item">
                            <a class="<?= schogms_registrar_nav_link_class('ched_masterlist.php') ?>" href="ched_masterlist.php">
                                <i data-feather="list" class="feather-icon"></i>
                                <span class="hide-menu">CHED TDP masterlist</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="<?= schogms_registrar_nav_link_class('verified-scholars.php') ?>" href="verified-scholars.php">
                                <i data-feather="award" class="feather-icon"></i>
                                <span class="hide-menu">Verified scholars</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="<?= schogms_registrar_nav_link_class('program_list.php') ?>" href="program_list.php">
                                <i data-feather="folder" class="feather-icon"></i>
...
if (!function_exists('schogms_registrar_render_sidebar')) {
    function schogms_registrar_render_sidebar(): void
    {
        ?>
        <aside class="left-sidebar" data-sidebarbg="skin6">
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <?php schogms_registrar_sidebar_menu_items(); ?>
                    </ul>
                </nav>
            </div>
        </aside>
...
if (!function_exists('schogms_registrar_shell_open')) {
    function schogms_registrar_shell_open(?string $pageTitle = null): void
    {
        ?>
        <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6"
            data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        <?php
        schogms_registrar_render_topbar($pageTitle);
        schogms_registrar_render_sidebar();
        ?>
