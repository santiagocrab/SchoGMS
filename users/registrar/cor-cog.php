<?php
/**
 * COR & COG hub — same flow as coordinator (separate COR / COG pages + bulk upload).
 */
...
<head>
    ...
    <?php schogms_registrar_head(false); ?>
</head>
<body>
<?php schogms_loading_screen_once(); ?>

<?php schogms_registrar_shell_open('COR & COG'); ?>
        <div class="container-fluid">
            ...
            require __DIR__ . '/../coordinator/inc/cor_cog_bulk_upload_panel.php';
            ?>
            <div class="row">
                <div class="col-12">
                    <div class="card border-primary">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-0 small">
                                Use <strong>Bulk upload</strong> on the COR or COG page, or upload both types below.
                                Full instructions are at the bottom of each page under <strong>Here is the format</strong>.
                            </p>
                        </div>
                    </div>
                </div>
