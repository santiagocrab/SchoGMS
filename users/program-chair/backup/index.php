                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?= $totalStudents; ?></h2>
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Records
                                    </h6>
                                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <h5>Displaying Students for: <strong><?php echo htmlspecialchars($campus); ?></strong></h5>
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var courseLabels = studentsData.map(item => item.course_program_enrolled);
                    ...
                    window.courseChart = new Chart(ctx, {
                        type: 'bar',
                        data: {
                            labels: courseLabels, // This will be hidden
                            datasets: [{
                                label: "Students per Course Program",
                        ...
                        options: {
                            ...
                            scales: {
                                x: {
                                    ticks: {
                                        display: false // 🚀 Hides bottom labels
                                    },
                                    grid: {
                                        display: false // Optional: Hides grid lines
                                    }
                                },
                                y: {
                                    beginAtZero: true,
