<?php
/**
 * Lean CSS/JS for program chair pages.
 */
require_once __DIR__ . '/../../../inc/schogms_app_scripts.php';

if (!function_exists('schogms_program_chair_head')) {
    function schogms_program_chair_head(bool $datatables = false): void
    {
...
if (!function_exists('schogms_program_chair_footer_scripts')) {
    /** @param array{datatables?:bool} $opts */
    function schogms_program_chair_footer_scripts(array $opts = []): void
    {
