...
try {
    ...
    if ($result_users && $result_users_role_status) {
        ...
        $total_coordinators = $row_users_role_status['total_coordinators'] ?? 0;
        $total_chairman = $row_users_role_status['total_chairman'] ?? 0;
        $total_registrars = $row_users_role_status['total_registrars'] ?? 0;
        $total_active_users = $row_users_role_status['total_active_users'] ?? 0;
        $total_restricted_users = $row_users_role_status['total_restricted_users'] ?? 0;
    }
