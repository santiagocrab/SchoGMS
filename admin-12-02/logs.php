                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>Coordinator/Program Head</th>
                                                <th>Details</th>
                                                <th>Date & Time</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>File Uploaded</td>
                                                <td>Eric Pratt (Coordinator)</td>
                                                <td>Uploaded Sales_Report_Jan2025.xlsx</td>
                                                <td>2025/01/05 10:30 AM</td>
                                            </tr>
                                            <tr>
                                                <td>File Uploaded</td>
                                                <td>Jane Smith (Program Head)</td>
                                                <td>Uploaded Employee_Attendance_Dec2024.xlsx</td>
                                                <td>2025/01/03 03:15 PM</td>
                                            </tr>
                                            <tr>
                                                <td>File Updated</td>
                                                <td>Vishal Bhatt (Coordinator)</td>
                                                <td>Updated Project_Budget_2025.xlsx</td>
                                                <td>2025/01/02 09:45 AM</td>
                                            </tr>
                                            <tr>
                                                <td>File Deleted</td>
                                                <td>Michael Brown (Program Head)</td>
                                                <td>Deleted Customer_Feedback_Q4_2024.xlsx</td>
                                                <td>2025/01/01 12:00 PM</td>
                                            </tr>
                                            <tr>
                                                <td>File exported</td>
                                                <td>Steve Johnson (Coordinator)</td>
                                                <td>Uploaded Monthly_Report_Feb2025.xlsx</td>
                                                <td>2025/01/06 11:00 AM</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
